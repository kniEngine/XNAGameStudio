...
namespace Primitives3D
{
    ...
    public class Primitives3DVRGame : Microsoft.Xna.Framework.Game
    {
        ...
        public Primitives3DVRGame()
        {
            ...
            xrDevice = new XRDevice("Primitives3DVR", this.Services);
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            if (xrDevice.DeviceState == XRDeviceState.Disabled)
            {
                try
                {
                    ...
                    int xrCreateResult = xrDevice.BeginSessionAsync();
                    if (xrCreateResult == 0)
                    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (xrDevice.DeviceState == XRDeviceState.Enabled)
            {
                ...
                if (ovrResult >= 0)
                {
                    var headsetState = xrDevice.GetHeadsetState();
                    ...
                    float aspectRatio = (float)xrDevice.GetEyeRenderTarget(XREye.Left).Width / xrDevice.GetEyeRenderTarget(XREye.Left).Height;
