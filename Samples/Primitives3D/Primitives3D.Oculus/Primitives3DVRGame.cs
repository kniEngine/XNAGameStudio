...
namespace Primitives3D
{
    ...
    public class Primitives3DVRGame : Microsoft.Xna.Framework.Game
    {
        ...
        public Primitives3DVRGame()
        {
            ...
            // create xrDevice device
            xrDevice = new XRDevice("Primitives3D", this.Services);
        }
        ...
        protected override void Initialize()
        {
            ...
            xrDevice.BeginSessionAsync(XRSessionMode.AR);
            ...
            if (xrDevice.DeviceState == XRDeviceState.Enabled)
            {
                ...
                try
                {
                    ...
                    foreach (XREye eye in xrDevice.GetEyes())
                    {
                        ...
                        // Get eye XR view and projection.
        ...
        void HandleInput()
        {
            ...
            TouchController.SetVibration(TouchControllerType.RTouch, lvibe);
        }
