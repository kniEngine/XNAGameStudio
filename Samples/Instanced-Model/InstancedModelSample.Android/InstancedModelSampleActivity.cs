...
{
    [Activity(Label = "InstancedModelSample"
        , MainLauncher = true
        , Icon = "@drawable/icon"
    ...
    public class InstancedModelSampleActivity : Microsoft.Xna.Framework.AndroidGameActivity
    {
        protected override void OnCreate(Bundle bundle)
        {
            base.OnCreate(bundle);
            var game = new InstancedModelSampleGame();
