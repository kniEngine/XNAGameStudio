...
namespace BoxCollider
{
    ...
    struct CustomVertex : IVertexType
    {
        ...
        (
            ...
            new VertexElement(48, VertexElementFormat.Vector2, VertexElementUsage.TextureCoordinate, 3)
            //new VertexElement(56, VertexElementFormat.Vector3, VertexElementUsage.Binormal, 0),
            //new VertexElement(68, VertexElementFormat.Vector3, VertexElementUsage.Tangent, 0)
        );
